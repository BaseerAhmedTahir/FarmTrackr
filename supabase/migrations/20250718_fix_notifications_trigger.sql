-- Fix notifications user_id and add auto-insert trigger
BEGIN;

-- First, let's create a function to handle expense notifications
...
BEGIN
    ...
    INSERT INTO public.notifications (
        ...
        goat_user_id, -- Use the goat owner's user_id
        'New Expense Added',
