-- This migration adds the profit_share column to caretakers and creates the caretaker summary view

-- Add profit_share column if it doesn't exist (idempotent)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 
...
-- Drop view if exists to ensure clean creation
DROP VIEW IF EXISTS v_caretaker_summary;

-- Create the caretaker summary view
